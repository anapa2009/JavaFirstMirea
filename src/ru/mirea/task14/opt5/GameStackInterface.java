...
public class GameStackInterface {
    Stack <Integer> fpl, spl; //fpl - 1-st player; spl - 2-nd player

    //--------------------------------------------------
    public GameStackInterface (String fpl, String spl) {
    ...
    public String play () {
        ...
        while ( (!fpl.isEmpty()) && (!spl.isEmpty()) && (count < 106)) {
            ...
            //меняем текст в метках
            //firstStart.setText() = (String) fpl;
            //secondStart.setText() = (String) spl;
            //Thread.sleep (500);
        ...
        if (count < 106) {
            ...
            if (spl.isEmpty())
                res += "first ";
            res += "; ходов: " + Integer.toString (count);
        } else
            res += "ходов: " + Integer.toString (count) + "; botva"; //res += "; botva";
        return res;
    }
